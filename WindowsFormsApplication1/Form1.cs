...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            etiket1 = atama.Text;
            etiket2 = karsilastir.Text;
            etiket3 = aritmetiksel.Text;
            etiket4 = mantiksal.Text;
            etiket5 = hesapzaman.Text;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (("Mod" == comboBox1.Text) || ("Normal" == comboBox1.Text))
            {
            ...
            else if  ("Satırlar" == comboBox1.Text)
            {
            ...
            else if ("SatırVeNo" == comboBox1.Text)
            {
                int say2=1;
            ...
            else if ("Sözcükler" == comboBox1.Text)
            {
                int say2 = 1;
            ...
            Word.Text ="Sözcük: "+ wordsize.ToString();
            Syllable.Text = "Hece: " + syllablesize.ToString();
            ...
            atama.Text= etiket1 + assign.ToString();
            karsilastir.Text = etiket2 + comp.ToString();
            aritmetiksel.Text = etiket3 + aritmetik.ToString();
            mantiksal.Text = etiket4 + logic.ToString();
            hesapzaman.Text = etiket5 + elapsed.TotalSeconds.ToString();
